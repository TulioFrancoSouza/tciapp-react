    ...
    <div className='max-w-[400px] mx-auto my-2 p-4'>
      ...
      <form className='mt-6' onSubmit={handleSubmit}>
        <div className='flex flex-col py-2'>
          <input onChange={(e) => setEmail(e.target.value)} className='border p-2 rounded-lg border-zinc-700' type='email' placeholder='Email'/>
        </div>
        <div className='flex flex-col py-2'>
          <input onChange={(e) => setPassword(e.target.value)} className='border p-2 rounded-lg border-zinc-700' type='password' placeholder='Password'/>
        </div>
