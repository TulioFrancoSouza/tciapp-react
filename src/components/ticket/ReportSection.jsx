              ...
              <thead>
                ...
                {extraExpenses != null &&
                  ...
                  extraExpenses
                    ...
                    .map((extraExpense, index) => (
                      <tr
                        key={Object.keys(extraExpense)[index]}
                        className="border-t-2 text-left p-2 border-gray-300"
                      >
                        ...
                        <td>
                          <div>
                            <FcEmptyTrash
                              onClick={(e) =>
                                handleRemoveExtraExpense(e, index)
                              }
                            />
                          </div>
                        </td>
